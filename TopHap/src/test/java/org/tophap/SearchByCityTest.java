...
public class SearchByCityTest extends MultipleWebTest {
    ...
    @Test
    @Order(1)
    void returnedResultsAreInSearchedCityArea() throws InterruptedException {
        ...
        assertEquals(
                ...
                searchItemList.stream()
                        .map(SearchItem::getCity)
                        .filter(CITY_NAME::equals)
                        .count());
    ...
    @Test
    @Order(2)
    void serverResultsHaveSubmittedCity() throws IOException {
